    ...
    <div className="min-h-screen bg-gradient-to-br from-kebrchacha-darker via-kebrchacha-dark to-kebrchacha-gray text-white">
      <div className="px-6 py-8">
        ...
        <div className="text-center mb-12">
          <div className="w-20 h-20 bg-gradient-to-br from-kebrchacha-gold to-kebrchacha-orange rounded-full flex items-center justify-center text-3xl font-bold text-black mx-auto mb-4 shadow-2xl animate-pulse">
            K
          </div>
          <h1 className="text-3xl font-bold mb-2">
            Welcome to <span className="text-kebrchacha-gold">Kebrchacha</span> Bingo
          </h1>
        ...
        <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 mb-8 text-center border border-white/20">
          <div className="text-4xl font-bold text-kebrchacha-green mb-2">{activeGames.toLocaleString()}+</div>
          <div className="text-white/70">Active Players Online</div>
          <div className="flex justify-center gap-2 mt-3">
            <div className="w-2 h-2 bg-kebrchacha-green rounded-full animate-pulse"></div>
            <div className="w-2 h-2 bg-kebrchacha-green rounded-full animate-pulse delay-75"></div>
            <div className="w-2 h-2 bg-kebrchacha-green rounded-full animate-pulse delay-150"></div>
          </div>
        </div>
        ...
        <div className="bg-white/5 backdrop-blur-sm rounded-xl p-4 border border-white/10">
          <h3 className="font-bold mb-3 text-kebrchacha-gold">🎮 How to Play</h3>
